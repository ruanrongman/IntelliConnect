...
public final class HookProviderGrpc {
  ...
  public static final class HookProviderStub extends io.grpc.stub.AbstractStub<HookProviderStub> {
    ...
    @Override
    protected HookProviderStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class HookProviderBlockingStub extends io.grpc.stub.AbstractStub<HookProviderBlockingStub> {
  ...
  /**
   */
  public static final class HookProviderFutureStub extends io.grpc.stub.AbstractStub<HookProviderFutureStub> {
