...
public interface KnowledgeChatRepository extends JpaRepository<KnowledgeChatEntity, Long> {
  ...
  @Transactional
  List<KnowledgeChatEntity> deleteAllByProductIdAndFilename(int productId, String filename);
}
