  ...
  <div class="register-container">  
    <div class="register-box">  
      ...
      <div class="register-form">  
        <h2 class="welcome-text">用户注册</h2>  
        <p class="sub-title">创建您的账户</p>  
        ...
        >  
          ...
          >  
            <a-space>  
              <a-input   
                v-model:value="registerForm.userCode"   
                size="large"   
                placeholder="验证码"   
                style="width: 200px"   
              >  
...
const handleSendCode = async () => {   
  ...
  if(!/^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/.test(registerForm.email)) {   
...
const handleSubmit = async (values) => {   
  ...
  try {   
    ...
    if (res.data.errorCode === 200) {   
      ...
      message.error(res.data.errorMsg || '注册失败')   
    }   
  } catch (err) {   
